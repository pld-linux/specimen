...
Specimen jest kontrolowanym z poziomu MIDI samplerem dźwiękowym dla
systemów GNU/Linux. Pozwala na tworzenie muzyki z przeróżnych plików
dźwiękowych czy też "sampli" w połączeniu z sekwencerem MIDI.
